      ...
      <div class="page-header clear-filter" filter-color="orange">
          ...
          <div class="content">
              <div class="container">
                      ...
                      <div class="col-md-4">
                      <button type="button" class="btn btn-info btn-round btn-lg btn-block" data-toggle="modal"
                              data-target=".bd-example-modal-lg4">Ambil Survei kehamilan</button>
                      </div>
                      <div class="col-md-4">
                      <button type="button" class="btn btn-info btn-round btn-lg btn-block" data-toggle="modal"
...
<div class="modal fade bd-example-modal-lg1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
                ...
                <hr>
                <form action="<?=base_url('C_index/post_riwayat_checkup_web')?>" method="POST">
                <div class="row">
...
<div class="modal fade bd-example-modal-lg3" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <form action="<?=base_url('C_form_profile_hamil/post_create_web')?>" method="POST" enctype="multipart/form-data">
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="nama">Nama Ibu Hamil</label>
                <input required type="text" value="<?= $rs_data_profile[0]->nama??""?>" name="nama" class="form-control" id="nama" placeholder="Nama">
            </div>
            <div class="form-group col-md-6">
                <label for="TTL">Tempat,Tanggal lahir</label>
                <div class="row">
                    <div class="col-6">
                        <input required type="text" value="<?= $rs_data_profile[0]->tempat_lahir??""?>" name="tempat_lahir" class="form-control" id="TTL" placeholder="Tempat Lahir">
                    </div>
                    <div class="col-6">
                        <input required type="date" value="<?= $rs_data_profile[0]->tgl_lahir??""?>" name="tgl_lahir" class="form-control" id="">
                    </div>
                </div>
            </div>
            <div class="col-4">
                ...
                <select name="bln_kehamilan" id="bulan_lahir" class="form-control" style=" background: rgba(0, 0, 0, 0.2);">
                    ...
                    <?php
                    for ($x = 1; $x <= 9; $x++) {
                    if($rs_data_profile[0]->bln_kehamilan??"" == $x){
                        $sel = "selected";
                    }else{
                        $sel = "";
                    }
            ...
            <div class="col-8">
                ...
                <select name="agama" id="agama" class="form-control" style=" background: rgba(0, 0, 0, 0.2);">
                    <option value="" <?= $rs_data_profile[0]->agama??"" == ""?"selected":"" ?> class="form-control">Pilih Agama</option>
                    <option value="Islam" <?= $rs_data_profile[0]->agama??"" == "Islam"?"selected":"" ?> class="form-control">Islam</option>
                    <option value="Protestan" <?= $rs_data_profile[0]->agama??"" == "Protestan"?"selected":"" ?> class="form-control">Protestan</option>
                    <option value="Katolik" <?= $rs_data_profile[0]->agama??"" == "Katolik"?"selected":"" ?> class="form-control">Katolik</option>
                    <option value="Hindu" <?= $rs_data_profile[0]->agama??"" == "Hindu"?"selected":"" ?> class="form-control">Hindu</option>
                    <option value="Buddha" <?= $rs_data_profile[0]->agama??"" == "Buddha"?"selected":"" ?> class="form-control">Buddha</option>
                    <option value="Khonghucu" <?= $rs_data_profile[0]->agama??"" == "Khonghucu"?"selected":"" ?> class="form-control">Khonghucu</option>
                </select>
            </div>
            <div class="form-group col-7 mt-1">
                ...
                <select name="pendidikan_terakhir" id="pendidikan" class="form-control" style=" background: rgba(0, 0, 0, 0.2);">
                    <option value="" <?= $rs_data_profile[0]->pendidikan_terakhir??"" == ""?"selected":"" ?> class="form-control">Pilih Pendidikan</option>
                    <option value="SD" <?= $rs_data_profile[0]->pendidikan_terakhir??"" == "SD"?"selected":"" ?> class="form-control">SD</option>
                    <option value="SMP" <?= $rs_data_profile[0]->pendidikan_terakhir??"" == "SMP"?"selected":"" ?> class="form-control">SMP</option>
                    <option value="SLTA/SMU/SMK" <?= $rs_data_profile[0]->pendidikan_terakhir??"" == "SLTA/SMU/SMK"?"selected":"" ?> class="form-control">SLTA/SMU/SMK</option>
                    <option value="D3" <?= $rs_data_profile[0]->pendidikan_terakhir??"" == "D3"?"selected":"" ?> class="form-control">D3</option>
                    <option value="S1/D4" <?= $rs_data_profile[0]->pendidikan_terakhir??"" == "S1/D4"?"selected":"" ?> class="form-control">S1/D4</option>
                    <option value="S2" <?= $rs_data_profile[0]->pendidikan_terakhir??"" == "S2"?"selected":"" ?> class="form-control">S2</option>
                    <option value="S3" <?= $rs_data_profile[0]->pendidikan_terakhir??"" == "S3"?"selected":"" ?> class="form-control">S3</option>
                </select>
            </div>
            <div class="form-group col-5 mt-1">
                ...
                <select name="gol_darah" id="gol" class="form-control" style=" background: rgba(0, 0, 0, 0.2);">
                    <option value="" <?= $rs_data_profile[0]->gol_darah??"" == ""?"selected":"" ?> class="form-control">Pilih Golongan Darah</option>
                    <option value="A" <?= $rs_data_profile[0]->gol_darah??"" == "A"?"selected":"" ?> class="form-control">A</option>
                    <option value="B" <?= $rs_data_profile[0]->gol_darah??"" == "B"?"selected":"" ?> class="form-control">B</option>
                    <option value="AB" <?= $rs_data_profile[0]->gol_darah??"" == "AB"?"selected":"" ?> class="form-control">AB</option>
                    <option value="O" <?= $rs_data_profile[0]->gol_darah??"" == "O"?"selected":"" ?> class="form-control">O</option>
                </select>
            </div>
            <div class="form-group col-md-6">
                <label for="pekerjaan">Pekerjaan</label>
                <input required type="text" value="<?= $rs_data_profile[0]->pekerjaan??"" ?>" name="pekerjaan" class="form-control" id="pekerjaan" placeholder="Pekerjaan">
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="fileinput fileinput-new text-center" data-provides="fileinput">
          <div class="fileinput-new thumbnail">
            <?php if($rs_data_profile[0]->img_profile!=""||$rs_data_profile[0]->img_profile!=null){?>
              <img id="previewImg" src="<?= base_url('uploads/').$rs_data_profile[0]->img_profile?>" alt="pic">
            <?php
            }else{
            ?>
...
<div class="modal fade bd-example-modal-lg4" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <div class="row container">
              ...
              <form action="<?=base_url('C_screening/post_create_survei_web')?>" method="POST">
    <div class="card-body">
