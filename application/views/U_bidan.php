    ...
    <?= $this->session->userdata("notif_edit");$this->session->unset_userdata("notif_edit")?>
      ...
      <div class="form-group">
            ...
            <div class="form-group">
              ...
              <button type="button"class="btn btn-info float-right btn-sm" onclick="$('#modalklinik').modal('toggle');">Tambah Klinik</button>
              <table class="table table-shopping">
                ...
                ?>
                <tr id='<?=$fas->id_klinik?>'>
                  <td><button id='del<?=$fas->id_klinik?>' onclick='f_row_del(<?=$fas->id_klinik?>)' class='btn btn-danger btn-sm'><i class='fas fa-trash'></i>&nbsp Hapus</button></td>
      ...
      console.log($("#"+id_klinik).html())
        if($("#input"+id_klinik).val()==id_klinik){
          ...
          ls_append += "<tr id='"+id_klinik+"'>"+
            "<td><button id='del"+id_klinik+"' onclick='f_row_del("+id_klinik+")' class='btn btn-danger btn-sm'><i class='fas fa-trash'></i>&nbsp Hapus</button></td>"+
