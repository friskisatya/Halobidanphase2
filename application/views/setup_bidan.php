...
<div class="table-responsive">
        <table class="table table-shopping">
            <thead>
                ...
                <th class="text_right h6 align-middle bg-info text-white"onclick="window.location='<?=base_url('C_setup_bidan/create')?>'">Tambah Data</th>
            </thead>
            ...
            <?php
                ...
                ?>
                    <tr>
                        ...
                        <td>
                        <button class="btn btn-danger m-1" data-toggle="modal" data-target="#delete<?=$bid->id_bidan?>" type="button"><i class="fas fa-trash"></i>&nbsp Hapus</button>
                    ...
                    <div class="modal fade mt-5" id="delete<?=$bid->id_bidan?>" tabindex="-1" role="dialog" aria-labelledby="delete" aria-hidden="true">
