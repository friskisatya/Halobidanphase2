        ...
        <div class="card ml-5 mr-4 p-3 bg-light" style="width: 94%;top: -50px;">
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto text-center">
                    <h3 class="title" id="layanan">Menu Setup Bidan</h3>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_bidan" id="nama_bidan" class="form-control"
                                    placeholder="Nama Bidan" value="<?=$rs_bidan[0]->nama_bidan?>">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="date" name="mulai_bekerja" id="mulai_bekerja" class="form-control" required
                                    value="<?=$rs_bidan[0]->mulai_bekerja?>">
                            </div>
                            <div class="form-group">
                                <label for="alamat_bidan">Alamat Bidan</label>
                                <Textarea required name="alamat_bidan" id="alamat_bidan" class="form-control" cols="50"
                                    rows="20"><?=$rs_bidan[0]->alamat_bidan?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="telp_bidan">Telepon Bidan</label>
                                <div class="input-group">
                                    <input required type="number" name="telp_bidan" class="form-control" id="telp_bidan"
                                        required value="<?=$rs_bidan[0]->telp_bidan?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="gelar" id="gelar" class="form-control"
                                    ...
                                    <option <?=$rs_bidan[0]->gelar=="Amd.Keb"?"selected":"" ?> value="Amd.Keb">Amd.Keb
                                    </option>
                                    <option <?=$rs_bidan[0]->gelar=="S.Tr.Keb."?"selected":"" ?> value="S.Tr.Keb.">
                                        S.Tr.Keb.</option>
                                </select>
                            </div>
                            <div class="form-group">
                ...
                ?>
                                        <tr id='<?=$fas->id_klinik?>'>
                                            <td><button id='del<?=$fas->id_klinik?>'
                                                    onclick='f_row_del(<?=$fas->id_klinik?>)'
                                                    class='btn btn-danger btn-sm'><i class='fas fa-trash'></i>&nbsp
                                                    Hapus</button></td>
                                            <td><input type='hidden' id='input<?=$fas->id_klinik?>'
                                                    value='<?=$fas->id_klinik?>' name='klinik[]'><?=$fas->nama_klinik?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                            ...
                            <div class="form-group">
                                ...
                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        ...
                                        <img id="previewImg" src="<?= base_url('uploads/').$rs_bidan[0]->img_profile?>"
                                            alt="pic">
                                        <?php
            }else{
            ?>
