          ...
          <div class="card ml-5 mr-4 p-3 bg-light" style="width: 94%;top: -50px;">
              <div class="row">
                  <div class="col-md-8 ml-auto mr-auto text-center">
                      <h3 class="title" id="layanan">Detail Klinik
                      </h3>
                  </div>

                  <div class="container">
                    <?php foreach($rs_klinik as $klinik){ ?>
                        <div class="col-12">
                            <h6 class="float-right btn-sm btn-primary ml-1 bg-info" onclick="window.location='<?=base_url('C_index/index_web')?>'"><i
